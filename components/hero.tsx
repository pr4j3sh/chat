export default function Header() {
  return (
    <div className="flex flex-col gap-8 items-center">
      <h1 className="scroll-m-20 pt-8 md:pt-0 text-4xl font-extrabold tracking-tight lg:text-5xl">
        Query
      </h1>
      ...
      <p className="leading-7 md:w-3/6 text-center [&:not(:first-child)]:mt-6">
        sleek app integrated with GROQ AI that delivers precise, concise answers
